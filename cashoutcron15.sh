...
sleep 600
echo 'Node-13'
./cashout13.sh | awk '{sum+=$2} END {print "sum=",sum}'
./cashout13.sh cashout-all 5
sleep 600
echo 'Node-14'
./cashout14.sh | awk '{sum+=$2} END {print "sum=",sum}'
./cashout14.sh cashout-all 5
sleep 600
echo 'Node-15'
./cashout15.sh | awk '{sum+=$2} END {print "sum=",sum}'
./cashout15.sh cashout-all 5
echo 'End'
